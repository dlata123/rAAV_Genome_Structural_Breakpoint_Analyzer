...
## Notes
RNAfold structure files (.ps) and outputs files are not included in the repository because they can be regenerated by running the workflow. Output folders are generated automatically during runtime.
