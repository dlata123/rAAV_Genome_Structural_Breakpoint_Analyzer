...
RNAfold structure files (`.ps`) and workflow-generated output files are not included in the repository because these files are large and can be regenerated by running the workflow. Output folders are created automatically during runtime.
